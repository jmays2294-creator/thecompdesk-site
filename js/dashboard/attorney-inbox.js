...
(function (window, document) {
  ...
  var CSS = [
    ...
    '.cc-di-dot{background:#B0560A;color:#fff;border-radius:999px;font-size:10.5px;font-weight:700;',
    ...
    '.cc-di-send{background:#B0560A;color:#fff;border:0;border-radius:10px;padding:10px 18px;',
